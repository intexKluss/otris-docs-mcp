---
title: "Class: Layout"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.Layout.html"
---
...
**addGadgetConfig(gadgetConfig)**
Add a gadgetConfig for this layout

| Name | Type | Description |
| --- | --- | --- |
| gadgetConfig | GadgetConfig | gadgetConfig (gadgetId, gadgetScript, gadgetAction, are mandatory) |
...
A given `GadgetConfig`**(with gadgetId)** is automatically converted to the corresponding gadget container.

The `GadgetConfig` is also automatically added through `addGadgetConfig()`.

| Name | Type | Description |
| --- | --- | --- |
| newHtml | string | GadgetConfig | repeatable html code to append |
...
**getGadgetConfigs(){Array.<GadgetConfig>}**
...
| Type | Description |
| --- | --- |
| Array.<GadgetConfig> | array of gadgetConfigs |
...
**setGadgetConfigs(gadgetConfigs)**
Set gadgetConfigs for this layout. **Deletes all previous definitions.**

| Name | Type | Description |
| --- | --- | --- |
| gadgetConfigs | Array.<GadgetConfig> | Array of gadgetConfigs (gadgetId is mandatory) |
