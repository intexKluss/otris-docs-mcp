---
title: "Class: Chart"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.Chart.html"
---
...
| --- | --- | --- |
| type | string | The chart type i.e. line or bar corresponding to the chart types in the chart.js library |
| data | object | The data for the chart. See chart.js documentation. |
| options | object | The options for the chart. See chart.js documentation. |
...
**getChartConfiguration(){object}**
Get the full chart configuration object with all parameters.
...
| Type | Description |
| --- | --- |
| object | full chart configuration object |
...
Documents 5.0h
- Deprecated
Not supported in ChartJS 4. Use chart configuration for this.
...
| Type | Description |
| --- | --- |
| function | chart onClick handler |
...
Deprecated since Documents 6.3.0.

- Since:
Documents 5.0h
- Deprecated
Use getChartConfiguration() instead.
...
Set the full chart configuration object with all parameters.

| Name | Type | Description |
| --- | --- | --- |
| chartConfiguration | object | the full chart configuration object |

- Since:
Documents 6.3.0


**setChartOnClickHandler(onClickHandler)**
...
Not supported in ChartJS 4. Use chart configuration for this, example below.

| Name | Type | Description |
| --- | --- | --- |
| onClickHandler | function | the handler to be executed |
...
chart.setChartOnClickHandler(function clickAction(index, dataset) {
 	documentsContext.openMessageDialog('Chart Click', 'Value: ' + dataset.data[index]);
 });
```


```
// ChartJS 4: handle click in configuration
var chart = new otris.gadget.gui.Chart("pie", data, {
...
| Name | Type | Description |
| --- | --- | --- |
| data | object | the new data of the chart |

- Deprecated
Use setChartConfiguration() instead.
...
| Name | Type | Description |
| --- | --- | --- |
| options | object | the new options of the chart |
...
| Name | Type | Description |
| --- | --- | --- |
| type | string | the new type of the chart |
