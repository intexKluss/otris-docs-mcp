---
title: "Class: XML"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.XML.html"
---
...
| --- | --- | --- |
| xml | string | the xml to return to the client |
| viewId | string | optional the view id of the object (The viewId specifies the destination in the DOM. This destination must exist otherwise the gadget is not rendered.) |
