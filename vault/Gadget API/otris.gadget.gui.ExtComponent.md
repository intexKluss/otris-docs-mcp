---
title: "Class: ExtComponent"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.ExtComponent.html"
---
...
| --- | --- | --- |
| extclass | string | the extclass for this object |
| config | object | the ext-config |
| uniqueid | string | the unique id to identify this instance as a unique object |
| viewId | string | optional the viewId of this element (The viewId specifies the destination in the DOM. This destination must exist otherwise the gadget is not rendered.) |
