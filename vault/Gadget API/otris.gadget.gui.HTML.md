---
title: "Class: HTML"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.HTML.html"
---
...
| Name | Type | Description |
| --- | --- | --- |
| newHtml | string | Array.<string> | html code to append |

- Since:
Documents 5.0f


**compileTemplate(templatedata, before, after)**
...
This way of creating templated html is deprecated.

It is highly recommended to use the Handlebars-Environment instead.

| Name | Type | Description |
| --- | --- | --- |
| templatedata | object | An object containing the templatedata |
| before | string | optional A text to put before the html of this Object |
| after | string | optional A text to put after the html of this Object |
...
```
const strHtml = "<h1>Welcome to my Gadget</h1> Hello {salutation} {firstname} {lastname} you are now using my first gadget.";
const htmlGadget = new otris.gadget.gui.HTML(strHtml);
htmlGadget.compileTemplate({ salutation: "Mr", firstname: "John", lastname: "Doe" });
