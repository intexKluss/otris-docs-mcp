---
title: "Class: ScriptTree"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.ScriptTree.html"
---
...
| --- | --- | --- |
| rootItem | otris.TreeItem | The root item of the tree. See Script Extensions API for details |
...
The callbackFunction must have the following signature: **function(selectedIds, documentsContext) {}**

| Name | Type | Description |
| --- | --- | --- |
| id | string | id for the action. |
| label | string | The label for the button |
| dialogActionCallback | function | The function that is executed if the button is clicked. dialogActionCallback(selectedIds, documentsContext) Dialog action function Name Type Description selectedIds Array.<string> The date as string of the clicked item documentsContext documents.sdk.DocumentsContext The DocumentsContext instance | Name | Type | Description | selectedIds | Array.<string> | The date as string of the clicked item | documentsContext | documents.sdk.DocumentsContext | The DocumentsContext instance |
| Name | Type | Description |
| selectedIds | Array.<string> | The date as string of the clicked item |
...
```
gadgetScriptTree.addDialogAction("apply", context.getFromSystemTable("gadget_api_common_button_apply"), function(selectedIds, documentsContext) {
    console.log("APPLY", selectedIds, documentsContext);
...
**function(node, selectedIds, documentsContext) {}**

| Name | Type | Description |
| --- | --- | --- |
| onClickFunction | function | Function with the following signature: function(node, selectedIds, documentsContext) {} |
...
```
gadgetScriptTree.setOnClick(function(node, selectedIds, documentsContext) {
    console.log("CLICK", node, selectedIds, documentsContext);
});
```
...
```
gadgetScriptTree.setOnDoubleClick(function(node, selectedIds, documentsContext) {
    console.log("DOUBLE CLICK", node, selectedIds, documentsContext);
});
```
...
| Name | Type | Description |
| --- | --- | --- |
| openTreeLevel | number | tree level |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| renderRootNode | boolean | true | optional Render the root node? |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| useTreeSearch | boolean | false | optional Display a search field? |
