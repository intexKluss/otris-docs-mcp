---
title: "Class: DropForm"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.DropForm.html"
---
...
| --- | --- | --- |
| dropConfiguration | object | drop configuration Name Type Description processCallback function callback function which processes the data of the submitted form dropFormProcessCB() Callback function which processes the data of the submitted form buttons boolean | object true for adding the default buttons or a custom container button configuration (see: otris.gadget.gui.DropForm#setContainerButtons) | Name | Type | Description | processCallback | function | callback function which processes the data of the submitted form dropFormProcessCB() Callback function which processes the data of the submitted form | buttons | boolean | object | true for adding the default buttons or a custom container button configuration (see: otris.gadget.gui.DropForm#setContainerButtons) |
| Name | Type | Description |
| processCallback | function | callback function which processes the data of the submitted form dropFormProcessCB() Callback function which processes the data of the submitted form |
| buttons | boolean | object | true for adding the default buttons or a custom container button configuration (see: otris.gadget.gui.DropForm#setContainerButtons) |
