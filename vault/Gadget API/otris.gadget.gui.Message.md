---
title: "Class: Message"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.Message.html"
---
...
| messageType | string | info | optional the type of the message (error/info/warn) |
...
| Type | Description |
| --- | --- |
| this | current instance for chaining methods |


**setMessageType(messageType){this}**
Set the messageType
