...
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.TreeChart.html"
---
...
| --- | --- | --- |
| treeChart | otris.treechart.TreeChart |  |
...
```
var gadgetTreeChart, treeChart;
treeChart = new otris.treechart.TreeChart();
// see the Script Extensions API for a detailed
// description of the class otris.treechart.TreeChart
gadgetTreeChart = new otris.gadget.gui.TreeChart(treeChart);
```
