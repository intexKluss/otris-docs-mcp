---
title: "Class: Transferable"
source: "https://otris.software/documents/api/gadgets/otris.gadget.gui.Transferable.html"
---
...
| --- | --- | --- |
| viewId | string | optional the viewId of the transferable object (The viewId specifies the destination in the DOM. This destination must exist otherwise the gadget is not rendered.) |


### Methods


**addClientFunction(clientFn, functionName)**
...
**addContainerButton(buttonConfig){object}**
...
**addOnGadgetLoad(onLoadHandlerFunction)**
...
**getContainerButton(buttonId){object|undefined}**
...
**getContainerButtons(){Array.<object>}**
...
**getGadgetType(){string|undefined}**
...
**setContainerButtons(containerButtonConfigs, options)**
...
**setNavibarEntry(gadgetConfig, label)**
