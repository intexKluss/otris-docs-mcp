---
title: "Class: RecordFileEntry"
source: "https://otris.software/documents/api/record-library/RecordFileEntry.html"
---
...
****
            ...
            Entry which is created from a DocFile
...
**setValueFromField(name, fieldName)**

            Sets the value of a column from the value of a field in the DocFile
        | Name | Type | Description |
| --- | --- | --- |
| name | string | technical name of the column |
| fieldName | string | name of the field to copy the value from |
