...
source: "https://otris.software/documents/api/client-sdk/documents.sdk.SessionStorage.html"
---
...
```
var storage = documentsContext.getSessionStorage();  //  -> "custom" session storage
console.log(storage.toJSON());
```


```
var storage = documentsContext.getSessionStorage("oceanic");  //  -> "oceanic" session storage
console.log(storage.toJSON());
```
