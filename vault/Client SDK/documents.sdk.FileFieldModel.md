---
title: "Class: FileFieldModel"
source: "https://otris.software/documents/api/client-sdk/documents.sdk.FileFieldModel.html"
---
...
Every FileFieldModel is a [Backbone.Model](http://backbonejs.org/#Model).
...
| Type | Description |
| --- | --- |
| string | background-color of the history field |
...
| Type | Description |
| --- | --- |
| string | border-color of the history field |
...
| Type | Description |
| --- | --- |
| string | font-color of the history field |
...
| Type | Description |
| --- | --- |
| string | the fields maximum length |
...
| Type | Description |
| --- | --- |
| string | reference-key of a Reference-field |
...
| Name | Type | Description |
| --- | --- | --- |
| height | string | the fields height |
...
**setHistoryFieldBgColor(backgroundcolor)**
Sets the background-color of the history field

| Name | Type | Description |
| --- | --- | --- |
| backgroundcolor | string | of the history field |

- Since:
6.0


**setHistoryFieldBorderColor(bordercolor)**
Sets the border-color of the history field

| Name | Type | Description |
| --- | --- | --- |
| bordercolor | string | of the history field |

- Since:
6.0


**setHistoryFieldColor(fontcolor)**
Sets the font-color of the history field

| Name | Type | Description |
| --- | --- | --- |
| fontcolor | string | of the history field |
...
| Name | Type | Description |
| --- | --- | --- |
| maxLength | string | the fields maximum length |
